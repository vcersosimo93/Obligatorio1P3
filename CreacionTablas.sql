...
create table vacuna(
	...
	rangoEdadInf int not null,
	rangoEdadSup int not null,
...
create table laboratorio_vacuna(
	idVacuna int not null constraint idVacuna_lab_fk foreign key (id) references vacuna(id),
	id int not null constraint id_fk foreign key (id) references laboratorio(id),
	constraint laboratorio_vacuna_pk primary key (idVacuna,id),
)
